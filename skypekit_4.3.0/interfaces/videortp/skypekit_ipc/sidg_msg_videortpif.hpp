...
namespace SkypeVideoRTPInterfaceMsgs {
  ...
  struct MsgSetFramerateRequest {
    enum { BEGIN = 92, END = 93 };
    int framerate_fps;
  };
  struct MsgSetFramerateResponse {
    enum { BEGIN = 93, END = 94 };
    bool rv;
  };
