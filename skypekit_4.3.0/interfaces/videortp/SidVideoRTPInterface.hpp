...
struct SkypeVideoRTPInterface
{
	...
	Fields:
		...
		can_do_cabac - CABAC main profile feature
		can_do_wp - weighted prediction, main profile feature
		can_do_8x8 - 8x8 transform, hight profile feature */
	...
	virtual bool  SetBitrate(int bitrate_bytes_sec) = 0;
