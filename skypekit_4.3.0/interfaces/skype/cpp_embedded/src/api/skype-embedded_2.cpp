...
unsigned int Skype::moduleID() const 
{
        return 0;
}
...
void Participant::OnLiveSessionVideosChanged(
) {}
...
extern const PMAP MESSAGE_PERMISSIONS_MAP[] = {
        {__EA(PERM_NONE), Message::PERM_NONE},
        {__EA(PERM_EDITABLE), Message::PERM_EDITABLE},
        {__EA(PERM_DELETABLE), Message::PERM_DELETABLE},
        {0, 0}
};

namespace Sid {
        template<> Sid::String tostring(const Message::PERMISSIONS& v)
        {
                return enumtostring("Message::PERMISSIONS",MESSAGE_PERMISSIONS_MAP,v);
        }
}
...
extern const PMAP SMS_PROPERTY_MAP[] = {
        ...
        {__EA(OUTGOING_REPLY_TYPE), Sms::P_OUTGOING_REPLY_TYPE},
...
extern const PMAP SMS_OUTGOING_REPLY_TYPE_MAP[] = {
        {__EA(REPLY_SKYPENAME), Sms::REPLY_SKYPENAME},
        {__EA(REPLY_USER_PHONE_NR), Sms::REPLY_USER_PHONE_NR},
        {__EA(REPLY_2WAY_AUTOASSIGNED_NR), Sms::REPLY_2WAY_AUTOASSIGNED_NR},
        {__EA(REPLY_TYPE_MIXED), Sms::REPLY_TYPE_MIXED},
        {0, 0}
};

namespace Sid {
        template<> Sid::String tostring(const Sms::OUTGOING_REPLY_TYPE& v)
        {
                return enumtostring("Sms::OUTGOING_REPLY_TYPE",SMS_OUTGOING_REPLY_TYPE_MAP,v);
        }
}
...
extern const EMAP SMS_EMAP[] = {
        ...
        {Sms::P_OUTGOING_REPLY_TYPE, SMS_OUTGOING_REPLY_TYPE_MAP},
...
extern const PMAP ACCOUNT_LOGOUTREASON_MAP[] = {
        ...
        {__EA(ATO_BLOCKED), Account::ATO_BLOCKED},
        {__EA(REMOTE_LOGOUT), Account::REMOTE_LOGOUT},
        {0, 0}
};
...
extern const PMAP SKYPE_QUALITYTESTTYPE_MAP[] = {
...
namespace Sid {
        template<> Sid::String tostring(const Skype::QUALITYTESTTYPE& v)
        {
                return enumtostring("Skype::QUALITYTESTTYPE",SKYPE_QUALITYTESTTYPE_MAP,v);
        }
}

extern const PMAP SKYPE_QUALITYTESTRESULT_MAP[] = {
...
namespace Sid {
        template<> Sid::String tostring(const Skype::QUALITYTESTRESULT& v)
        {
                return enumtostring("Skype::QUALITYTESTRESULT",SKYPE_QUALITYTESTRESULT_MAP,v);
        }
}

void Skype::OnQualityTestResult(
        __se_unused const QUALITYTESTTYPE& /*testType*/,
        __se_unused const QUALITYTESTRESULT& /*testResult*/,
        __se_unused const Sid::String& /*withUser*/,
        __se_unused const Sid::String& /*details*/,
        __se_unused const Sid::String& /*xmlDetails*/
) {}
...
bool Skype::start() { bool r; if (!Start(r) || !r) { stop(); return false; } return true; }
