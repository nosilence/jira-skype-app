                ...
                switch (modid) {
                        case 0:
                                switch(evid) {
                                        ...
                                        case 28: { //Skype::OnQualityTestResult
                                                MsgqualitymonitorOnQualityTestResult msg;
                                                if (protocol->rd_parms(thread,&msg,MsgqualitymonitorOnQualityTestResult::BEGIN) != Sid::Protocol::OK) return Sid::Protocol::ERR_DECODE;
                                                OnQualityTestResult(static_cast<Skype::QUALITYTESTTYPE>(msg.testType),static_cast<Skype::QUALITYTESTRESULT>(msg.testResult),msg.withUser,msg.details,msg.xmlDetails);
                                                return Sid::Protocol::OK;
                                        }
                        ...
                        case 19: // Participant
                                switch(evid) {
                                        ...
                                        case 146: { //Participant::OnLiveSessionVideosChanged
                                                MsgconversationParticipantOnLiveSessionVideosChanged msg;
                                                if (protocol->rd_parms(thread,&msg,MsgconversationParticipantOnLiveSessionVideosChanged::BEGIN) != Sid::Protocol::OK) return Sid::Protocol::ERR_DECODE;
                                                Participant* o = static_cast<Participant*>(__can_dispatch(&msg.objectID));
                                                if (o) o->OnLiveSessionVideosChanged();
                                                return Sid::Protocol::OK;
                                        }
                                        default: return protocol->sk_parms(thread);
                                }
