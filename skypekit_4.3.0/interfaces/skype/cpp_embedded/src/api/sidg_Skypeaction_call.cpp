...
{
        SERootObject* __session = this;
        bool __status = __session->call_0n(5,"ZR\000\221\001",MsgconfigStartResponse::BEGIN,&started);
        return __status;
}
...
bool Participant::GetLiveSessionVideos(
        VideoRefs& videos
)
{
        SERootObject* __session = root;
        Sid::CommandInitiator* __cmdini;
        if (__session->call_mn(__cmdini,5,"ZR\023\221\001",MsgconversationParticipantGetLiveSessionVideosRequest::BEGIN,&object_id)) {
                bool __status = __session->rd_parms_lst(__cmdini,MsgconversationParticipantGetLiveSessionVideosResponse::BEGIN,&videos);
                return __status;
        }
        return false;
}
...
bool Conversation::TransferLiveSession(
        ...
        const Sid::Binary context/* Leave empty if you don't know what to use it for */
)
{
        SERootObject* __session = root;
        return __session->call_m0(4,"ZR\022(", MsgconversationConversationTransferLiveSessionRequest::BEGIN,&object_id,&identities,&transferTopic,&context);
}
...
bool Conversation::PostFiles(
        ...
        const Sid::String& body,/* Alternative text to send to clients not supporting displaying the POSTED_FILES message */
...
bool Conversation::AttachVideoToLiveSession(
        const VideoRef& sendVideo
)
{
        SERootObject* __session = root;
        return __session->call_m0(5,"ZR\022\223\001", MsgconversationConversationAttachVideoToLiveSessionRequest::BEGIN,&object_id,&sendVideo);
}
...
bool Skype::GetConversationByIdentity(
        ...
        ConversationRef& conversation,
        const bool matchPSTN/* The matchPSTN parameter changes the behaviour of the method for PSTN numbers.
...
)
{
        SERootObject* __session = this;
        Sid::CommandInitiator* __cmdini;
        if (__session->call_mn(__cmdini,4,"ZR\000\017",MsgconversationGetConversationByIdentityRequest::BEGIN,&convoIdentity,&matchPSTN)) {
...
)
{
        ...
        int __rsp_result;
        Sid::CommandInitiator* __cmdini;
        if (__session->call_mn(__cmdini,4,"ZR\011:",MsgconversationMessageGetPermissionsRequest::BEGIN,&object_id)) {
                bool __status = __session->rd_parms_lst(__cmdini,MsgconversationMessageGetPermissionsResponse::BEGIN,&__rsp_result);
                result=static_cast<PERMISSIONS>(__rsp_result);
                return __status;
        }
        return false;
}
...
bool Message::Edit(
        ...
        const Sid::String legacyPrefix/* If the edit is received by a client not supporting displaying edits,
                              it will be shown as a new message, prefixed by this parameter.
                              Default value is a prefix in English. */
)
{
        SERootObject* __session = root;
        return __session->call_m0(4,"ZR\011\002", MsgconversationMessageEditRequest::BEGIN,&object_id,&newText,&isXML,&undo,&legacyPrefix);
}
...
)
{
        SERootObject* __session = this;
        Sid::CommandInitiator* __cmdini;
        if (__session->call_mn(__cmdini,5,"ZR\000\217\001",MsgvideoCreateLocalVideoRequest::BEGIN,&type,&deviceName,&devicePath)) {
                bool __status = __session->rd_parms_lst(__cmdini,MsgvideoCreateLocalVideoResponse::BEGIN,&video);
                return __status;
        }
        return false;
}

bool Skype::CreatePreviewVideo(
        const Video::MEDIATYPE& type,
        VideoRef& video,
        const Sid::String deviceName,/* name and path to be used only with media type VIDEO */
        const Sid::String devicePath
)
{
        SERootObject* __session = this;
        Sid::CommandInitiator* __cmdini;
        if (__session->call_mn(__cmdini,5,"ZR\000\220\001",MsgvideoCreatePreviewVideoRequest::BEGIN,&type,&deviceName,&devicePath)) {
                bool __status = __session->rd_parms_lst(__cmdini,MsgvideoCreatePreviewVideoResponse::BEGIN,&video);
                return __status;
        }
        return false;
}
...
bool Skype::StartMonitoringQuality(
...
{
        SERootObject* __session = this;
        return __session->call_m0(5,"ZR\000\214\001", MsgqualitymonitorStartMonitoringQualityRequest::BEGIN,&withUser,&excludeNetworkTest);
}

bool Skype::StopMonitoringQuality(
...
)
{
        ...
        int __rsp_result;
        Sid::CommandInitiator* __cmdini;
        if (__session->call_mn(__cmdini,5,"ZR\000\215\001",MsgqualitymonitorStopMonitoringQualityRequest::BEGIN,&withUser,&justStop)) {
                bool __status = __session->rd_parms_lst(__cmdini,MsgqualitymonitorStopMonitoringQualityResponse::BEGIN,&__rsp_result);
                result=static_cast<QUALITYTESTRESULT>(__rsp_result);
                return __status;
        }
        return false;
}
...
)
{
        SERootObject* __session = root;
        Sid::CommandInitiator* __cmdini;
        if (__session->call_mn(__cmdini,4,"ZR\014\003",MsgsmsSmsGetTargetReplyNumberRequest::BEGIN,&object_id,&target)) {
                bool __status = __session->rd_parms_lst(__cmdini,MsgsmsSmsGetTargetReplyNumberResponse::BEGIN,&number);
                return __status;
        }
        return false;
}

bool Sms::GetTargetReplyType(
        const Sid::String& target,
...
)
{
        ...
        int __rsp_type;
        Sid::CommandInitiator* __cmdini;
        if (__session->call_mn(__cmdini,4,"ZR\014\012",MsgsmsSmsGetTargetReplyTypeRequest::BEGIN,&object_id,&target)) {
                bool __status = __session->rd_parms_lst(__cmdini,MsgsmsSmsGetTargetReplyTypeResponse::BEGIN,&__rsp_type);
                type=static_cast<OUTGOING_REPLY_TYPE>(__rsp_type);
                return __status;
        }
        return false;
}
...
bool Skype::GetAccount(
        const Sid::String& identity,/* can be NULL or '' for account with no identity yet (needed for oAuth login) */
        AccountRef& account
)
{
        SERootObject* __session = this;
...
bool Skype::GetSupportedUILanguageList(
        Sid::List_String& uiLanguageCodeList
)
{
        SERootObject* __session = this;
        bool __status = __session->call_0n(5,"ZR\000\207\001",MsgisoGetSupportedUILanguageListResponse::BEGIN,&uiLanguageCodeList);
        return __status;
}
