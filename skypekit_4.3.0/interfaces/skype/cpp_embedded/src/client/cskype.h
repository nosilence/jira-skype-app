...
public:
        ...
        void OnQualityTestResult(const QUALITYTESTTYPE& testType, const QUALITYTESTRESULT& testResult, const Sid::String& withUser, const Sid::String& details, const Sid::String& xmlDetails);
