...
class Message(skypekit.Object):
    ...
    def Edit(
        ...
        B{Arguments:}
         ...
         - B{legacy_prefix} - If the edit is received by a client not supporting displaying edits, it will be shown as a new message, prefixed by this parameter. Default value is a prefix in English.
        """
